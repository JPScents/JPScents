...
function ProductImage({ perfume, className }: { perfume: PublicPerfumeCard; className: string }) {
  return perfume.primaryImageUrl ? (
    ...
    <ProductBottlePlaceholder className={className} />
  );
}
    ...
    >
      <article className="border-b py-5 sm:border sm:bg-jp-surface sm:p-3">
        <div className="relative aspect-[1.1/1] overflow-hidden bg-jp-stone sm:aspect-[4/5]">
          <ProductImage perfume={perfume} className="h-full w-full object-cover" />
          {perfume.label && (
      ...
      >
        {leading ? (
          <div className="relative aspect-[4/3] bg-jp-stone">
            <ProductImage perfume={perfume} className="object-contain" />
            {perfume.label && (
          ...
          <div className="relative aspect-[7/8] bg-jp-stone lg:aspect-[4/3]">
            <ProductImage perfume={perfume} className="object-contain" />
          </div>
        )}
      </Link>
