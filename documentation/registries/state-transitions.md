...
| Order | `NEW` / `AWAITING_PAYMENT` / `CONFIRMED` / `CANCELLED` | Admin-controlled; exact permitted transition matrix remains open |
...
Whether cancellation restores variant quantity automatically is open.
